...
<span class="form-inline">
    <div class="input-group">
        <input type="text" data-name="{$field->getFormName()}" class="object-select" {if $field->get()>0} value="{$field->getPublicTitle()}"{/if} {$field->getAttr()} data-request-url="{$field->getRequestUrl()}">
