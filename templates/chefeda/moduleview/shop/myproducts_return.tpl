...
{if $order_list}
    <div class="page-responses returnsTable formTable">
        <div class="tabs gray ordersTabs">
            <ul class="tabList">
                <li class="act"><a href="#">{t}Мои возвраты{/t}</a></li>
            </ul>
            ...
            <div class="tab act">
                    <form class="formStyle" action="{urlmake Act="add"}" method="GET">
                        <div class="form-group">
                            ...
                            <div class="formLine buttonLine buttons cboth">
    ...
    {if $returns_list}
        <div class="page-responses tabs gray topMarg returnsTable myReturns">
            <ul class="tabList">
                <li class="act"><a href="#">{t}Ваши заявки{/t}</a></li>
            </ul>
