...
<section class="filterSection" data-query-value="{$url->get('query', $smarty.const.TYPE_STRING)}">
    ...
    <form method="GET" class="filters" action="{urlmake filters=null pf=null bfilter=null p=null escape=true}" autocomplete="off">
        ...
        <a href="{urlmake pf=null p=null filters=null bfilter=null escape=true}" class="onemore cleanFilter{if empty($filters) && empty($basefilters)} hidden{/if}">{t}очистить фильтр{/t}</a>
