                        ...
                        <table class="items cartTable">
                            <tbody>
                                ...
                                <tr data-id="{$index}" data-product-id="{$cartitem.entity_id}" class="cartitem{if $item@first} first{/if}">
                                    ...
                                    <td class="remove"><a href="{$router->getUrl('shop-front-cartpage', ["Act" => "removeItem", "id" => $index, "floatCart" => $floatCart])}" title="{t}Удалить товар из корзины{/t}" class="iconRemove"></a></td>
                                </tr>
        ...
        <form method="POST" action="{$router->getUrl('shop-front-cartpage', ["Act" => "update"])}" id="cartForm" class="formStyle">
                        ...
                        {foreach $cart_data.items as $index => $item}
                            ...
                            <tr data-id="{$index}" data-product-id="{$cartitem.entity_id}" class="cartitem{if $smarty.foreach.items.first} first{/if}">
                                ...
                                <td class="title">
                                    ...
                                    {/if}
                                    <p class="desc">{$product.short_description|nl2br}</p>
                                </td>
                                <td class="amount">
                                ...
                                <td class="remove">
                                    <a title="{t}Удалить товар из корзины{/t}" class="removeItem" href="{$router->getUrl('shop-front-cartpage', ["Act" => "removeItem", "id" => $index])}"></a>
                                </td>
                            </tr>
            ...
            {hook name="shop-cartpage:bottom" title="{t}Корзина:подвал{/t}"}
                ...
                <div class="actionLine">
                    ...
                    <a href="{$router->getUrl('shop-front-checkout')}" class="submit button color{if $cart_data.has_error} disabled{/if}">{t}Оформить заказ{/t}</a>
                    {if $THEME_SETTINGS.enable_one_click_cart}            
