            ...
            <tr>
                <td class="otitle">{$elem.__number_prefix->getTitle()}&nbsp;&nbsp;{if $elem.__number_prefix->getHint() != ''}<a class="help-icon" title="{$elem.__number_prefix->getHint()|escape}">?</a>{/if}
                </td>
                <td>{include file=$elem.__number_prefix->getRenderTemplate() field=$elem.__number_prefix}</td>
            </tr>
                                            
            <tr>
                <td class="otitle">{$elem.__seal_url->getTitle()}&nbsp;&nbsp;{if $elem.__seal_url->getHint() != ''}<a class="help-icon" title="{$elem.__seal_url->getHint()|escape}">?</a>{/if}
                </td>
                <td>{include file=$elem.__seal_url->getRenderTemplate() field=$elem.__seal_url}</td>
            </tr>
                                            
            <tr>
                <td class="otitle">{$elem.__use_site_company->getTitle()}&nbsp;&nbsp;{if $elem.__use_site_company->getHint() != ''}<a class="help-icon" title="{$elem.__use_site_company->getHint()|escape}">?</a>{/if}
                </td>
                <td>{include file=$elem.__use_site_company->getRenderTemplate() field=$elem.__use_site_company}</td>
            </tr>
