    ...
    */
    private function addOrderItems(\Shop\Model\Orm\Order $order)
    {
        $order->getPropertyIterator()->append(array(
            'dateof_iso' => new \RS\Orm\Type\MixedType(array(
            ...
            'items' => new \RS\Orm\Type\MixedType(array(
            ...
            'files' => new \RS\Orm\Type\MixedType(array(
                'description' => t('Файлы прикреплённые к заказу'),
                'appVisible' => true
            )),  
            'additional_fields' => new \RS\Orm\Type\MixedType(array(
        ...
        $prototype->getPropertyIterator()->append(array(
            'image' => new \RS\Orm\Type\MixedType(array(
                'description' => t('Фото'),
                'appVisible' => true
            )),
