...
class SelectDocument extends User
{
    ...
    {
        $this->view_attr = array('size' => 40, 'placeholder' => t('id документа'));
    ...
    {
        return $this->request_url ?: \RS\Router\Manager::obj()->getAdminUrl('ajaxSearchDocument', array('document_type' => $this->getType()), 'catalog-inventory');
    }
