...
class SelectReservation extends User
{
    ...
    {
        $this->view_attr = array('size' => 40, 'placeholder' => t('id, номер предзаказа, ФИО'));
    ...
    {
        return $this->request_url ?: \RS\Router\Manager::obj()->getAdminUrl('ajaxSearchReservation', array(
    ...
    function getPublicTitle()
    {
        ...
        return t('Предзаказ №%num от %date', array(
            'num' => $reservation['id'],
