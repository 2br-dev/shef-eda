...
class File extends \RS\Orm\ConfigObject
{
    function _init()
    {
        parent::_init()->append(array(
            ...
            t('Купоны на скидку'),
                ...
                'fixed_discount_max_order_item_percent' => new Type\Decimal(array(
                    'description' => t('Максимальная доля товарной позиции в процентах, которую можно оплатить купоном на фиксированную сумму'),
                )),
        ));
    }
    ...
    {
        return \Shop\Model\RegionApi::regionsList();
    }
    ...
    {
        return \Shop\Model\RegionApi::citiesList();
    }
