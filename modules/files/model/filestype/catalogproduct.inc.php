...
class CatalogProduct extends AbstractType
{
    ...
    */
    function getAccessTypes()
    {
        ...
        $access_list += array(
            static::ACCESS_TYPE_AUTHORIZED => array(
        ...
        if (\Setup::$SCRIPT_TYPE != 'Shop.Base') {
            $access_list += array(
                static::ACCESS_TYPE_AFTERPAY => array(
    ...
    */
    ...
    {
        if (in_array($file['access'], array(static::ACCESS_TYPE_AFTERPAY, static::ACCESS_TYPE_AUTHORIZED))) {
