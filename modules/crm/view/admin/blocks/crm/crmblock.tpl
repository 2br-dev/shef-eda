        ...
        <ul class="tab-nav" role="tablist">
            {if $param.tabs.deal}
                <li class="active">
                    ...
                    <a data-target="#crm-block-deal" data-toggle="tab" role="tab">{t}Сделки{/t} <span class="counter crm-deal">{$deal_data.paginator->total}</span></a>
                </li>
            {/if}
            {if $param.tabs.interaction}
                <li>
                    ...
                    <a data-target="#crm-block-interaction" data-toggle="tab" role="tab">{t}Взаимодействия{/t} <span class="counter crm-interaction">{$interaction_data.paginator->total}</span></a>
                </li>
            {/if}
            {if $param.tabs.userInteraction}
                <li>
                    ...
                    <a data-target="#crm-block-user-interaction" data-toggle="tab" role="tab">{t}Взаимодействия с пользователем{/t} <span class="counter crm-interaction-user">{$user_interaction_data.paginator->total}</span></a>
                </li>
            {/if}
            {if $param.tabs.task}
                <li>
                    ...
                    <a data-target="#crm-block-task" data-toggle="tab" role="tab">{t}Задачи{/t} <span class="counter crm-task">{$task_data.paginator->total}</span></a>
                </li>
            {/if}
        </ul>
