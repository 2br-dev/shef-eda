...
class DealBoardItem extends AbstractBoardItem
{
    ...
    public function getButtons($filters = array())
    {
        ...
        return array(
            new ToolbarButton\Add($router->getAdminUrl('add', array(), 'crm-dealctrl'), t('Добавить сделку')),
            new ToolbarButton\Button($router->getAdminUrl(false, array(), 'crm-dealctrl'), t('Табличный вид'))
        );
    }
