...
class Deal extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        ...
        $property_iterator->append(array(
            t('Основные'),
                '_tmpid' => new Type\Hidden(array(
                    'appVisible' => false,
                    'meVisible' => false
                )),
                'deal_num' => new Type\Varchar(array(
                ...
                'status_id' => new Type\Integer(array(
                    ...
                    'list' => array(array('\Crm\Model\Orm\Status', 'getStatusesTitles'), $this->getShortAlias())
                )),
                'manager_id' => new Type\User(array(
                    'description' => t('Менеджер, создавший сделку'),
                )),
                'client_type' => new Type\Enum(array_keys(self::getClientTypeTitles()), array(
                    'description' => t('Тип клиента'),
                    'list' => array(array(__CLASS__, 'getClientTypeTitles')),
                    'radioListView' => true,
                ...
                'client_name' => new Type\Varchar(array(
                ...
                'client_id' => new Type\UserDialog(array(
        ...
        $property_iterator->append(array(
            ...
            t('Задачи'),
                '__tasks__' => new \Crm\Model\OrmType\TaskBlock(array(
                    'linkType' => self::getSelfLinkManagerType()
                ))
        ));
    ...
    public function getPublicTitle()
    {
        ...
        return t('Сделка №%num c %user_name', array(
            'num' => $this['deal_num'],
