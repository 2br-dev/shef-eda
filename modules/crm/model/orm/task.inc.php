...
class Task extends OrmObject
{
    ...
    function _init()
    {
        ...
        parent::_init()->append(array(
            t('Основные'),
                'task_num' => new Type\Varchar(array(
                ...
                'links' => new \Crm\Model\OrmType\Link(array(
                ...
                'title' => new Type\Varchar(array(
                    ...
                    'checker' => array('ChkEmpty', t('Опишите суть задачи в одном предложении')),
                    'meVisible' => false,
                )),
                'status_id' => new Type\Integer(array(
                    'description' => t('Статус'),
                    'list' => array(array('\Crm\Model\Orm\Status', 'getStatusesTitles'), 'crm-task')
                )),
                ...
                'date_of_planned_end' => new Type\Datetime(array(
                    'description' => t('Планируемая дата завершения задачи')
                )),
                'date_of_end' => new Type\Datetime(array(
                    'description' => t('Фактическая дата завершения задачи')
                )),
                'expiration_notice_time' => new Type\Integer(array(
                    ...
                    'list' => array(array($config, 'getNoticeExpirationTimeList')),
                    'default' => $config->expiration_task_default_notice_time
                )),
                'expiration_notice_is_send' => new Type\Integer(array(
                ...
                'implementer_user_id' => new Type\User(array(
                    'description' => t('Исполнитель задачи'),
                )),
                'board_sortn' => new Type\Integer(array(
                    'description' => t('Сортировочный индекс на доске'),
                    'visible' => false
                )),
                'is_archived' => new Type\Integer(array(
                    'allowEmpty' => false,
            ...
            t('Настройки автозадачи'),
                'autotask_index' => new Type\Integer(array(
                    'description' => t('Порядковый номер автозадачи'),
                    'readOnly' => true,
                    'compare' => false,
                    'meVisible' => false,
                )),
                'autotask_group' => new Type\Integer(array(
                ...
                'autochange_status_rule' => new Type\Text(array(
                    'description' => t('Условия для смены статуса'),
                    'visible' => false,
                    'compare' => false
                ))
        ...
        $this->getPropertyIterator()->append(array(
            t('Файлы'),
                '__files__' => new \Files\Model\OrmType\Files(array(
        ...
        $this->addIndex(array('expiration_notice_is_send', 'date_of_planned_end', 'status_id'), self::INDEX_KEY);
    }
    ...
    public function beforeWrite($flag)
    {
        ...
        if (!$this['is_autochange_status']) {
            $this['autochange_status_rule_arr'] = array();
        }
    ...
    public function afterObjectLoad()
    {
        ...
        $this['autochange_status_rule_arr'] = @unserialize($this['autochange_status_rule']) ?: array();
    }
