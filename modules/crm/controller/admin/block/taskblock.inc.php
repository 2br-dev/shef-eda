...
class TaskBlock extends Block
{
    ...
    protected $default_n_sort = array( //Направление сортировки по умолчанию
        'date_of_create' => 'desc',
        'title' => 'asc',
        'creator_user_id' => 'asc',
    ...
    function actionIndex()
    {
        ...
        $cur_n_sort = $this->url->convert($this->url->request('nsort', TYPE_STRING, $cur_sort_n_default), array('desc','asc'));
        ...
        $paginator = new PaginatorElement($total, $url_pattern, array(
            'pageKey' => 'task_page',
     ...
     * @return string
     */
    function makeUrl($custom_params = array())
    {
    ...
    function actionRemove()
    {
        ...
        $ids = $this->url->request('task', TYPE_ARRAY, array());
