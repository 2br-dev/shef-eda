...
class WallPostApi
{
    ...
    public function getPostUrl($social_type)
    {
        ...
        $link = \Setup::$RS_SERVER_PROTOCOL.'://'.\Setup::$RS_SERVER_DOMAIN.'/wallpost/?'.http_build_query($auth_params + array(
    ...
    public function getCloseAlertUrl($social_type)
    {
        ...
        return $router->getAdminUrl('ajaxCloseSocialNotice', array('social_type' => $social_type), 'main-wallpost');
    }
}