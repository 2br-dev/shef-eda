...
class Memory extends AbstractSystemTest
{
    ...
    function getDescription()
    {
        ...
        return t('Для комфортной работы функций обработки изображений требуется не менее 64 MB памяти для PHP процесса (memory_limit). У вас установлено: %0', array($memory));
    }
