...
class MaxUploadSize extends AbstractSystemTest
{
    ...
    function getDescription()
    {
        ...
        return t('Для комфортной работы с системой, переменным upload_max_filesize и post_max_size в PHP.ini рекомендуется установить значение не менее 50 MB. У вас установлено: %0', array($max_upload_size));
    }
