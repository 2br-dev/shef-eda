...
{    
    ...
    */
     ...
     */
    public static function getAuthorizedApiMethodsSelectList(array $root_item = array(), $only_allowable = false, $lang = null, $cache = true)
    {
        $result = array();
        foreach(self::getApiMethods($cache, $only_allowable) as $method) {
            $method_instance = new $method['class']();
    ...
    */
    ...
    public static function getOriginForRequest($client_name = "", $client_version = "")
    {
        ...
        if (isset($headers['Origin']) && (in_array($headers['Origin'], array(
                    'http://localhost:8100',
                    'http://localhost:8080',
                    'http://localhost',
                    'ionic://localhost',
