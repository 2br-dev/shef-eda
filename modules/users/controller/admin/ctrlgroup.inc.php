...
class CtrlGroup extends Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Sort('sortn', t('Порядок'), array('sortField' => 'alias', 'Sortable' => SORTABLE_ASC, 'CurrentSort' => SORTABLE_ASC, 'ThAttr' => array('width' => '20'))),
                ...
                new TableType\Text('alias', t('Псевдоним'), array('ThAttr' => array('width' => '50'), 'Sortable' => SORTABLE_BOTH)),
            ...
            'Items' => array(
                ...
                new ToolbarButton\Dropdown(array(
                    ...
                    array(
                        ...
                        'attr' => array(
                            'href' => RouterManager::obj()->getAdminUrl('exportCsv', array('schema' => 'users-usersgroup', 'referer' => $this->url->selfUri()), 'main-csv'),
                            'class' => 'crud-add'
                        )
                    ),
                    array(
                        ...
                        'attr' => array(
                            'href' => RouterManager::obj()->getAdminUrl('importCsv', array('schema' => 'users-usersgroup', 'referer' => $this->url->selfUri()), 'main-csv'),
                            'class' => 'crud-add'
                        )
                    ),
                )),
    ...
    function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        $admin_tree = new TreeElement(array(
