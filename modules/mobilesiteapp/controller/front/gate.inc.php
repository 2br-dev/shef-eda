...
class Gate extends \RS\Controller\Front
{
    ...
    */
    ...
    function actionGetTemplatesJS()
    {
        ...
        localStorage.setItem('loaded_templates', JSON.stringify(".json_encode($loaded_templates, (defined('JSON_UNESCAPED_UNICODE')) ? JSON_UNESCAPED_UNICODE : 0)."));".
        "localStorage.setItem('extends_json', JSON.stringify(".json_encode($extends_json, (defined('JSON_UNESCAPED_UNICODE')) ? JSON_UNESCAPED_UNICODE : 0)."));";
    }
