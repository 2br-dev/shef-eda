    ...
    function _init()
    {
        parent::_init()->append(array(
            t('Основные'),
                ...
                'sms_sender_log' => new Type\Integer(array(
                    'description' => t('Вести лог отправки SMS'),
        ...
        return 
            parent::getDefaultValues() + array(
                'tools' => array(
                    ...
                    array(
                        'url' => \RS\Router\Manager::obj()->getAdminUrl('showSmsLog', array(), 'alerts-tools'),
                    ...
                    array(
                        'url' => \RS\Router\Manager::obj()->getAdminUrl('deleteSmsLog', array(), 'alerts-tools'),
