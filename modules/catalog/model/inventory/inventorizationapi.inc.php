 ...
 * @ingroup Catalog
 */
class InventorizationApi extends \RS\Module\AbstractModel\EntityList
{
    private
        $counter,
        $items,
    ...
    function makeTotalInventorization($current_warehouse, $offset, $inventory_id)
    {
        ...
        $manager = new \Catalog\Model\InventoryManager();
        $limit = 200;
        $second = false;
