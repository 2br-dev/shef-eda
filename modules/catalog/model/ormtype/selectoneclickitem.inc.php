...
class SelectOneClickItem extends User
{
    ...
    {
        $this->view_attr = array('size' => 40, 'placeholder' => t('id, номер покупки в 1 клик, ФИО, телефон'));
    ...
    {
        return $this->request_url ?: \RS\Router\Manager::obj()->getAdminUrl('ajaxSearchOneClickItem', array(
    ...
    function getPublicTitle()
    {
        ...
        return t('Покупка в 1 клик №%num от %date', array(
