...
class SelectDocument extends User
{
    ...
    {
        return $this->request_url ?: \RS\Router\Manager::obj()->getAdminUrl('ajaxSearchDocument', array('document_type' => $this->getType()), 'catalog-inventoryctrl');
    }
    ...
    {
        $this->view_attr = array_merge( $this->view_attr, array('minLength' => $min_length));
    }
