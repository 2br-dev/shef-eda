...
class Document extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'archived' => new Type\Integer(array(
            ...
            'provider' => new Type\Integer(array(
                'list' => array(array('Catalog\Model\Inventory\InventoryTools', 'staticSelectProviders')),
            ...
            'items_count' => new Type\Integer(array(
    ...
    function delete()
    {
        ...
        \RS\Orm\Request::make()
            ...
            ->where(array('document_id' => $this->id))
            ->exec();
        $stock_manager = new \Catalog\Model\InventoryManager();
        $api->deleteProductsByDocument($this['id']);
