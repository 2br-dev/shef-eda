    ...
    function helperIndex()
    {
        ...
        $helper -> setTable(new Table\Element(array(
                'Columns' => array(
                    ...
                    new TableType\Text('warehouse_from', t('Со склада'), array('Sortable' => SORTABLE_BOTH)),
                    new TableType\Text('warehouse_to', t('На склад'), array('Sortable' => SORTABLE_BOTH)),
                    ...
                    new TableType\Datetime('date', t('Дата оформления'), array('Sortable' => SORTABLE_BOTH)),
                ...
                'SecContainer' => new Filter\Seccontainer( array(
                    'Lines' =>  array(
                        new Filter\Line( array('Items' => array(
                            ...
                            new Filter\Type\Select('warehouse_from', t('Со склада'),  array('' => t('Неважно')) + \Catalog\Model\WareHouseApi::staticSelectList()),
                            new Filter\Type\Select('warehouse_to', t('На склад'),  array('' => t('Неважно')) + \Catalog\Model\WareHouseApi::staticSelectList()),
                        )
                        )),
                    )
                ))
