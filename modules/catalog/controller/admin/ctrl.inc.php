...
class Ctrl extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
        ...
        $inventory_control_fields = array(
            new TableType\Userfunc('remains', t('Остаток'),
                function($value){
                    return (float)$value;
                },
                array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
            new TableType\Userfunc('reserve', t('Резерв'),
                function($value){
                    return (float)$value;
                },
                array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
            new TableType\Userfunc('waiting', t('Ожидание'),
                function($value){
                    return (float)$value;
                },
                array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
                                        ...
                                        'Lines' => array(
                                            new Filter\Line( array(
                                                'Items' => array(
                                                    ...
                                                    new Filter\Type\Select('brand_id', t('Бренд'), array('' => t('Любой')) + \Catalog\Model\BrandApi::staticSelectList(array())),
        ...
        $add_to_document = array(new ToolbarButton\DropUp(array(
            ...
            array(
                ...
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Document::DOCUMENT_TYPE_ARRIVAL), 'catalog-inventoryctrl'),
            ...
            array(
                'title' => t('Списание'),
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Document::DOCUMENT_TYPE_WRITE_OFF), 'catalog-inventoryctrl'),
                    'class' => 'crud-multiaction',
                    'data-crud-dialog-height' => 400,
                    'data-crud-dialog-width' => $window_width,
                ),
            ...
            array(
                'title' => t('Ожидание'),
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Document::DOCUMENT_TYPE_WAITING), 'catalog-inventoryctrl'),
                    'class' => 'crud-multiaction',
                    'data-crud-dialog-height' => 400,
                    'data-crud-dialog-width' => $window_width,
                ),
            ...
            array(
                ...
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Document::DOCUMENT_TYPE_RESERVE), 'catalog-inventoryctrl'),
                    'class' => 'crud-multiaction',
                    'data-crud-dialog-height' => 400,
                    'data-crud-dialog-width' => $window_width,
                ),
            ...
            array(
                ...
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Inventorization::DOCUMENT_TYPE_INVENTORY), 'catalog-inventoryctrl'),
                    'class' => 'crud-multiaction',
                    'data-crud-dialog-height' => 400,
                    'data-crud-dialog-width' => $window_width,
                ),
            ...
            array(
                'title' => t('Перемещение'),
                'attr' => array(
                    'data-url' => $this->router->getAdminUrl('AddProductsFromCatalog', array('document_type' => \Catalog\Model\Orm\Inventory\Movement::DOCUMENT_TYPE_MOVEMENT), 'catalog-inventoryctrl'),
                    'class' => 'crud-multiaction',
                    'data-crud-dialog-height' => 400,
                    'data-crud-dialog-width' => $window_width,
                ),
